...
<div class="blog-sidebar">
    ...
    <div class="sidebar-widget sidebar-widget-1">
        ...
        <form class="search-form" action="{{ route('blog.list') }}">
            <input type="text" name="s" value="{{ request()->s }}" placeholder="Write your keyword...">
    ...
    <div class="sidebar-widget">
        ...
        <div class="recent-posts">
            <ul>
                ...
                <li>
                    <a class="post-link" href="{{ $mobile ? route('amp.blog.detail',$rb->slug) : route('blog.detail',$rb->slug) }}">
                        <div class="post-thumb">
                            <img src="{{ url('images/blog',$rb->image) }}" width="100px" alt="{{ $rb->title }}">
                        </div>
                        <div class="post-text">
