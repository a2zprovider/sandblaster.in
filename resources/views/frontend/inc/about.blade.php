...
<div class="about-breadcrumb-bg">
 <div class="container">
    <div class="row about-sty">
          <div class="col-sm-6"> <about> About Us </about></div>
          
          <div class="col-sm-6 float-st"> <a href="{{ route('home') }}"><i class="fas fa-home"></i> </a><ab> <i class="fa fa-angle-double-right"></i> About Us <ab> </div>
...
<div class="container">
  <div class="row">
       ...
       <div class="col-lg-6">
        ...
        <p>Our mission is to provide cutting-edge sand blasting machines that deliver unmatched precision, efficiency, and reliability. We are dedicated to enhancing surface treatment processes across industries by offering innovative solutions that improve cleaning, finishing, and preparation. By combining advanced technology with sustainable practices, we aim to empower businesses to achieve exceptional results while maintaining the highest standards of quality and performance.</p>
       </div>
  </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="why-choose-sty">
                   ...
                   <p>We design and manufacture advanced sand blasting machines tailored to meet the unique needs of various industries.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="why-choose-sty">
                ...
                <p>We specialize in providing high-quality surface cleaning, finishing, and preparation for materials such as metal, & concrete.</p>
             </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="why-choose-sty">
                ...
                <p>Offering customized sandblasting equipment and systems to ensure optimal performance for specific applications.</p>
             </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="why-choose-sty">
                   ...
                   <p>We serve a wide range of industries, including manufacturing, construction, automotive, aerospace, and more.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="why-choose-sty">
                ...
                <p>We provide ongoing maintenance services, training, and technical support to ensure your sandblasting equipment.</p>
             </div>
            </div>
            <div class="col-lg-4 col-md-4">
              <div class="why-choose-sty">
