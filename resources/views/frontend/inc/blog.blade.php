...
<div class="about-breadcrumb-bg">
    <div class="container">
       <div class="row about-sty">
             <div class="col-sm-6 col-md-6"> <about> Blogs </about> 
            </div>
            
             <div class="col-sm-6 float-st"> <a href="{{ route('home') }}"><i class="fas fa-home"></i> </a><ab> <i class="fa fa-angle-double-right"></i> Blogs <ab> </div>
       </div>
    </div>
   </div>
</div>
     ...
     <div class="col-lg-3">
           <div class="sticky">
            <div class="chksection">
               <div class="chk-row-sty">
                     ...
                     <ul>
                        ...
                        <li><a class="text-clip" href="{{ route('blog.category', $blogcat->slug) }}">{{$blogcat->title}}</a></li>
            ...
            <div class="chksection m-t-20"> 
               <div class="chk-row-sty">
                  ...
                  <div class="chkheading"><p>Recent Blogs</p></div>
                  <ul>
                     @foreach($blogsidebar as $blogsb)

                     <li><a class="text-clip" href="{{ route('blog.detail', $blogsb->slug) }}">{{$blogsb->title}}</a></li>
                     @endforeach
            ...
            <div class="chk-row-sty">
               ...
               <div class="chkheading"><p>Latest Tags</p></div>
            </div>  
            <div class="chk-row-sty"> 
               <ul>
                  @foreach($tagb as $tag)
                  <li><a class="text-clip" href="{{ route('blog.tag', $tag->slug) }}">{{$tag->title}}</a></li>
                  {{-- <li>{{$blog->tag?$blog->tag->title:''}}</li> --}}
                  @endforeach
          ...
          <div class="chksection m-t-20">
            <div class="chk-row-sty">
               ...
               <div class="chkheading"><p>Published Year</p></div>
               <ul>
            ...
            @foreach($blogs as $blog)
              <div class="blog-card mr-top-20">
                 <div class="row">
                    <div class="col-lg-5">
                      <div class="bc-img">
                     <a href="blogdetails"><img src="{{ $blog->thumb_image ? url('images/blog/' . $blog->thumb_image) : url('images/blog/' . $blog->image) }}" alt="{{ $blog->title }}"></a>
                      </div>  
                    </div>
                    <div class="col-lg-7">
                     <div class="cat-date-row">
                              <a href="{{ route('blog.detail', $blog->slug) }}"> <h2>{{ $blog->title }}</h2></a>
                              <div class="cat-row">
                                
                                <span> <i class="fa fa-th"></i> Category: {{$blog->blogcategory?$blog->blogcategory->title:''}} </span>
                              </div> 
                              <div class="date-row">
                                 
                                  <span> <i class="fa fa-calendar"></i>  Published On: {{ date_format($blog->created_at, 'F d, Y') }}</span>
                              </div>
