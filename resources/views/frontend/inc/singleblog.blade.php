...
<div class="about-breadcrumb-bg">
    <div class="container">
       <div class="row about-sty">
             <div class="col-lg-6 col-md-12"> <about> Granite Engraving Machine </about></div>
             <div class="col-lg-6 col-md-12 float-st-1"> <a href="{{ route('home') }}"><i class="fas fa-home"></i></a> <ab> <i class="fa fa-angle-double-right"></i></ab> <a href="{{ route('blog')}}">Blogs</a>  <ab><i class="fa fa-angle-double-right"></i>  Granite Engraving Machine </ab> </div>
       </div>
    </div>
   </div>
</div>
    ...
    <div class="row pb-t-50">
       ...
       <div class="col-lg-9 mr-top-20-s">
          <div class="container">
                ...
                <div class="blog-card">
                   <div class="row">
                    <img src="{{ url('images/blog', $post->image) }}" alt="{{$post->title}}">                      
                      </div>
                   </div>
                 <div class="blog-content-sty">
                    ...
                    <div class="cat-row">
                        ...
                        <span> <i class="fa fa-th"></i> Category: {{$post->blogcategory?$post->blogcategory->title:''}} </span>
                      </div>
                      <div class="date-row">
                         
                          <span> <i class="fa-solid fa-calendar"></i>  Published On: {{ $post->created_at->format('j F Y');}}</span>
                      </div>
                      <div class="blog-conetnt">
                        {!! $post->description !!}
