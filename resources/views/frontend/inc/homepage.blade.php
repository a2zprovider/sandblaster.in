    ...
    <div class="row head-text-sty">
       <div class="col-lg-6">
           <div class="slider-section">
                    ...
                    <div class="p-sty">
                         <p>Sand Blasting Machine can be used to eliminate old paint, decrease a rough exterior surface or give configuration to an object. Abrasives can be used such as copper slag, steel grit, pieces of walnut, powder abrasive, steel shot, plastic abrasive media, aluminum oxide, and many others.
                    </p>
                    </div>
              </div> 
           <div class="get-q-sty">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="why-choose-sty">
                   ...
                   <p>The material used in sandblasting, such as sand, steel grit, glass beads, or aluminum oxide, is crucial for the effectiveness of the process.</p>
                </div>
            </div>
            <div class="col-md-4"><div class="why-choose-sty">
                <img src="{{ asset('images/img/safety-icon.png') }}"  alt="job image" title="job image"/>
                <h3>Safety Considerations</h3>
                <p>Sand Blasting produces significant dust, which can be harmful to the operator’s health. Safety measures such as protective clothing, gloves, & goggles, are essential.</p>
             </div></div>
            <div class="col-md-4"><div class="why-choose-sty">
                <img src="{{ asset('images/img/cost-effective-icon.png') }}"  alt="job image" title="job image"/>
                <h3>Efficiency and Cost-Effectiveness</h3>
                <p>Sand Blasting is an efficient and quick method for cleaning and finishing. With the media reclamation system, abrasives can be reused, which makes it more cost-effective.</p>
             </div></div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="why-choose-sty">
                   ...
                   <p>Check if the blast pot is designed for easy loading and unloading of materials. Some machines come with features like automatic media flow systems for greater efficiency.</p>
                </div>
            </div>
            <div class="col-md-4"><div class="why-choose-sty">
                <img src="{{ asset('images/img/Noise and Dust Control.png') }}"  alt="job image" title="job image"/>
                <h3>Noise and Dust Control</h3>
                <p>For a safer and more comfortable working environment, look for machines that feature effective noise suppression and advanced dust control systems, such as vacuums.</p>
             </div></div>
            <div class="col-md-4"><div class="why-choose-sty">
                <img src="{{ asset('images/img/maintenance.png') }}"  alt="job image" title="job image"/>
                <h3>Ease of Use and Maintenance</h3>
                <p>Easy to operate and maintain, with features such as abrasive media refilling, & quick nozzle changes. A machine that’s difficult to use or maintain will lead to inefficiency.</p>
             </div></div>
        </div>
    </div>
   ...
   <div class="container">
      <div class="row">
         <div class="">
            ...
            <p class="psty-2">Exploring the Different Variations of Portable Sand Blasting Equipment for Efficient Surface Cleaning</p>
         </div>
         <div class="row">
            <div class="main-b-r">
              <div class="row-b-1"></div>
      ...
      <div class="row types-content">
        <div class="col-lg-6">
            <div class="types-content-sty pb-t-100">
               ...
               <p>Suction blasting machines are ideal for small to medium-sized jobs and are often used for light cleaning and surface preparation. They operate by drawing abrasive media into the blast hose through a venturi nozzle, where air pressure forces it onto the work surface. These machines are simple, cost-effective, and can be used with a variety of abrasives.</p>
            </div>
        </div>
        <div class="col-lg-6">
      ...
      <div class="row types-content">
        ...
        <div class="col-lg-6">
            <div class="types-content-sty pb-t-100">
               ...
               <p>Pressure blasting machines use a pressurized system to force abrasive media onto surfaces. The machine is pressurized, and when the nozzle is opened, the media is pushed out at a much higher speed than with suction machines. This results in faster and more aggressive cleaning, making it ideal for heavy-duty applications like rust removal or paint stripping.</p>
            </div>
        </div>
      ...
      <div class="row types-content">
        <div class="col-lg-6">
            <div class="types-content-sty pb-t-100">
               ...
               <p>Wet blasting machines mix water with the abrasive media, reducing dust and providing a cleaner finish. This type is particularly useful for applications where controlling airborne particles is essential, such as in indoor environments or for delicate parts that require a gentler approach.</p>
            </div>
        </div>
        <div class="col-lg-6">
            ...
            <div class="swiper-slide">
              ...
              <div class="card-sty">
                <aside class="card-h team1">
                    ...
                    <img src="{{ $blog->thumb_image ? url('images/blog/' . $blog->thumb_image) : url('images/blog/' . $blog->image) }}" class="blog-img" alt="{{$blog->title}}">
                    <div class="caption">
                    <h2 class="name"><a href="{{ route('blog.detail', $blog->slug) }}">{{$blog->title}}</a></h2>
                    <div class="card-cat-sty">
                      <p>  <i class="fa fa-th"></i> &nbsp; Category: {{$blog->title}} <p>
                    </div>
                    <p class="datesty"><i class="fa fa-calendar"></i> &nbsp; Published On: {{ date_format($blog->created_at, 'F d, Y') }}</p>
                    </div>
                </aside>
            </div>
            </div>
