        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h4 class="fw-bold m-0">
                    <span class="text-muted fw-light">Country /</span> View
                </h4>
                <div>
                    <div class="btn-danger btn" id="delete_record" style="margin-right: 20px;"> Delete </div>
                    <a href="{{ route('admin.country.create') }}" class="btn-primary btn text-white"> Add </a>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function handelDelete(id) {
        var url = "{{ route('admin.country.index') }}";
        url = url + '/' + id;
        Swal.fire({
            title: "Are you sure?",
