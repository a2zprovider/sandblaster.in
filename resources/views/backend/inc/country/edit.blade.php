...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {{ Form::open(['url' => route('admin.country.update',$country->id), 'method'=>'PUT', 'files' => true, 'class' => 'needs-validation','novalidate']) }}
        <div class="card mb-4 header-sticky">
            <div class="d-flex justify-content-between align-items-center py-3 mb-2 card-body">
                <h4 class="fw-bold m-0">
                    <span class="text-muted fw-light">Country /</span> Edit
                </h4>
                <div>
                    <a href="{{ route('admin.country.index') }}" class="btn-primary btn" type="reset" style="margin-right: 20px;">Cancel</a>
