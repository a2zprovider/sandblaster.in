...
@section('title','User History List')
@section('style')
        ...
        <div class="mb-4">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h4 class="fw-bold m-0">
                    <span class="text-muted fw-light">User History /</span> View
                </h4>
                <div>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.data-table').dataTable({
            ...
            serverSide: true,
            searchable: true,
            ajax: "{{ route('admin.userhistory.index') }}",
            ...
            if (ids_arr.length > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route("admin.userhistory.deleteAll") }}',
                            type: 'post',
                            data: {
                                request: 2,
                                ids_arr: ids_arr
    ...
    function handelDelete(id) {
        var url = "{{ route('admin.userhistory.index') }}";
        url = url + '/' + id;
        Swal.fire({
            title: "Are you sure?",
