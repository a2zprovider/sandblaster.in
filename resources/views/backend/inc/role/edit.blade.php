...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {{ Form::open(['url' => route('admin.role.update',$role->id), 'method'=>'PUT', 'files' => true, 'class' => 'needs-validation','novalidate']) }}
        <div class="card mb-4 header-sticky">
            <div class="d-flex justify-content-between align-items-center py-3 mb-2 card-body">
                ...
                <div>
                    <a href="{{ route('admin.role.index') }}" class="btn-primary btn" type="reset" style="margin-right: 20px;">Cancel</a>
