...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {{ Form::open(['url' => route('admin.slider.update',$slider->id), 'method'=>'PUT', 'files' => true, 'class' => 'needs-validation','novalidate']) }}
        <div class="card mb-4 header-sticky">
            <div class="d-flex justify-content-between align-items-center py-3 mb-2 card-body">
                ...
                <div>
                    <a href="{{ route('admin.slider.index') }}" class="btn-primary btn" type="reset" style="margin-right: 20px;">Cancel</a>
...
<script>
    ...
    myDropzone.emit("thumbnail", mockFile, "{{ url('images/slider/' . $slider->image) }}");
    myDropzone.emit("complete", mockFile);
    $('.image_file').val('{{ $slider->image }}')
</script>
@endif
@endsection