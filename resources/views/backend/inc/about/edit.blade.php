...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        {{ Form::open(['url' => route('admin.about.update'), 'method'=>'POST', 'files' => true, 'class' => 'needs-validation','novalidate']) }}
        <div class="card mb-4 header-sticky">
            <div class="d-flex justify-content-between align-items-center py-3 mb-2 card-body">
                <h4 class="fw-bold m-0">
                    <span class="text-muted fw-light">About Us /</span> Edit
                </h4>
                <div>
        ...
        @include('backend.inc.about._form')
...
<script>
    ...
    myDropzone.emit("thumbnail", mockFile, "{{ url('images/about/' . $about->image) }}");
    myDropzone.emit("complete", mockFile);
    $('.image_file').val('{{ $about->image }}')
</script>
@endif
