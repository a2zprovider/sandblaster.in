...
<div class="image-upload-url" data-url="{{ route('admin.application.image') }}"></div>
<div class="image-delete-url" data-url="{{ route('admin.application.image.delete') }}"></div>
<div class="thumb-image-upload-url" data-url="{{ route('admin.application.thumb_image') }}"></div>
<div class="thumb-image-delete-url" data-url="{{ route('admin.application.thumb_image.delete') }}"></div>